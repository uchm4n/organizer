...
return [
    ...
    'cache' => [
         ...
         * when using the default CacheProfile settings. The route-level
         * FlexibleCacheResponse middleware overrides this for each GET
         * endpoint (see routes/api.php); this is the fallback used by
         * CacheResponse::for() without an explicit lifetime.
         */
        'lifetime_in_seconds' => (int) env('RESPONSE_CACHE_LIFETIME', 15 * 60),
